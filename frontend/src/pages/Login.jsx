...
function SignUp() {
  ...
  return (
    <div className='w-[100vw] h-[100vh] flex items-center justify-center relative'>
      ...
      <form onSubmit={handleSubmit} className='max-w-[900px] w-[90%] h-[600px] flex items-center justify-center flex-col md:items-start gap-[10px]'>
        ...
        <button type="submit" className='px-[50px] py-[10px] bg-[red] text-[white] text-[18px] md:px-[100px] rounded-lg'>
          Login
        </button>
                <p className='text-[18px]'>Create new Account <span className='text-[18px] text-[red] cursor-pointer'onClick={()=> navigate('/signup')}>signup</span></p>
      </form>
    </div>
  );
}
